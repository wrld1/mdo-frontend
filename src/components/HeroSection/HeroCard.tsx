...
export default function HeroCard({
  ...
  useEffect(() => {
    ...
    const baseStyle = {
      ...
      transform: `${translatePart} ${baseRotation} scale(${
        isVisible ? 1 : 0.8
      })`,
    };
  ...
  return (
    <div
      className={`absolute shadow-[0_15px_50px_rgba(112, 129, 148, 0.1)] rounded-[1.5rem] sm:rounded-3xl border border-[#2e2e2e]/20 overflow-hidden ${className}`}
      style={style}
